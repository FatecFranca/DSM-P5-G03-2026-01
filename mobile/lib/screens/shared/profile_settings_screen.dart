...
//     // Define a máscara para telefone celular brasileiro: (99) 99999-9999
...
//           // 1. IMPEDIR LETRAS: Usa o formatador nativo do Flutter
//           inputFormatters: [
//             if (isTelefone) FilteringTextInputFormatter.digitsOnly,
//             if (isTelefone) maskFormatter,
//           ],
//           // 2. TECLADO NUMÉRICO: Abre o teclado de discagem
//           keyboardType: isTelefone
//               ? TextInputType.phone
//               : TextInputType.emailAddress,
//           decoration: InputDecoration(
//             labelText: 'Novo $label',
//             hintText: isTelefone ? '(00) 00000-0000' : 'exemplo@email.com',
...
//       try {
//         // Para o banco, enviamos apenas os números (opcional, dependendo da sua API)
//         // Se sua API aceita a máscara (parênteses e traço), use controller.text
//         // Se a API quer só números, use maskFormatter.getUnmaskedText()
//         final String newValue = isTelefone
...
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(
//               content: Text('⚠️ Erro: ${response.statusCode}'),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSettingsCard(themeModel, cs, fontSize),
                  const SizedBox(height: 32),
                  Center(child: Text('Versão 1.0.4 • Fatec Franca', style: GoogleFonts.inter(fontSize: 12, color: cs.onSurface.withOpacity(0.4)))),
                  const SizedBox(height: 100),
                ],
              ),
            ),
